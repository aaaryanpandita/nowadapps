...
//               <img
//                 src="/assets/brand/Nowa-logo-Horizonal.png"
//                 alt=""
...
//                     <li
//                       key={i}
//                       className={i !== section.links.length - 1 ? "mb-6" : ""}
//                     >
...
//               ©<a href="/">pagedone</a> {new Date().getFullYear()}, All rights
//               reserved.
//             </span>
...
//       { label: "About", href: "javascript:;" },
//       { label: "Pricing", href: "javascript:;" },
//     ],
//   },
//   {
//     title: "Products",
//     links: [
//       { label: "Figma UI System", href: "javascript:;" },
//       { label: "Icons Assets", href: "javascript:;" },
//       { label: "Responsive Blocks", href: "javascript:;" },
//     ],
//   },
//   {
//     title: "Support",
//     links: [
//       { label: "Customer Support", href: "javascript:;" },
//       { label: "Terms & Conditions", href: "javascript:;" },
//       { label: "Privacy Policy", href: "javascript:;" },
//     ],
//   },
//   {
//     title: "Subscribe",
...
const Footer = () => {
  return (
    <div className="w-full flex justify-center items-center px-2">
      <div
        className="hidden lg:flex mask-radial-from-100% absolute -left-0 
  bg-[rgba(100,231,158,1)]
  [mask:url('https://framerusercontent.com/images/rZAq7tOiXtvldHaj0f09JUo.svg')]
...
"
      ></div>
      <img
        src="/assets/footer/footer.avif"
        alt=""
        className=" object-contain h-96 absolute z-50 opacity-100 -left-44 hidden lg:flex"
      />
      <div className="max-w-7xl relative flex items-center justify-center">
        <div className="absolute hidden lg:flex text-[20rem] font-bold leading-0 text-gray-700/20">
          NOWA
        </div>

        <div className="w-full grid grid-cols-12 ">
          <div className="col-span-12 md:col-span-6">
            <p className="text-lg relative z-50">
              The crypto market doesn't have to be a guessing game. While others
              hope their trades work out, you can make informed decisions with
              institutional-grade AI predictions. Your 20,000 FREE tokens are
              waiting.
            </p>
          </div>
